            ...
            <form method="post" id="ticket_form">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label class="form-label" for="usu_asig">Asignar a:</label>
                        <select class="form-control" id="usu_asig" name="usu_asig" data-placeholder="Seleccione un usuario" required>
                        </select>
                </div>
